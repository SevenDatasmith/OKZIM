CREATE TABLE [erp].[PurchaseOrder]
(
...
GO
ALTER TABLE [erp].[PurchaseOrder] ADD CONSTRAINT [PK_PurchaseOrder] PRIMARY KEY CLUSTERED ([OrderNo]) ON [PRIMARY]
GO
EXEC sp_addextendedproperty N'MS_Description', N'0 = New, 1 = In Progress, 2 = Updated, 3 = Uploaded', 'SCHEMA', N'erp', 'TABLE', N'PurchaseOrder', 'COLUMN', N'Status'
GO
